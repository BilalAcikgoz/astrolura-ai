...
class BirthChartRequest(BaseModel):
    ...
    def validate_birth_date(cls, v: str) -> str:
        try:
            ...
            # Check reasonable date range (Swiss Ephemeris supports 13,000 years)
...
class BirthChartInterpretRequest(BaseModel):
    ...
    chart_id: str = Field(
        ...,
        description="UUID of the calculated birth chart"
    )
    ...
    language: Optional[str] = Field(
        default="tr",
        description="Language code for interpretation (tr, en)"
    )
