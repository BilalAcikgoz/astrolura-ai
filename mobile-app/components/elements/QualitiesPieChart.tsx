...
import { QUALITY_COLORS, QUALITY_NAMES } from '../../constants/zodiac';
...
export default function QualitiesPieChart({ qualities }: Props) {
  const slices: Slice[] = [
    { label: QUALITY_NAMES.cardinal, value: qualities.cardinal, color: QUALITY_COLORS.cardinal },
    { label: QUALITY_NAMES.fixed, value: qualities.fixed, color: QUALITY_COLORS.fixed },
    { label: QUALITY_NAMES.mutable, value: qualities.mutable, color: QUALITY_COLORS.mutable },
  ];

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Nitelikler</Text>
